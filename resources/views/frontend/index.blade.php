...
<!-- slider-area-start -->
			<div class="slider-area">
				<div id="slider">
					<img src="{{ URL::asset('frontend/img/slider/1.jpg')}}" alt="slider-img" title="#caption1" />
					<img src="{{ URL::asset('frontend/img/slider/2.jpg')}}" alt="slider-img" title="#caption2" />
					<img src="{{ URL::asset('frontend/img/slider/3.jpg')}}" alt="slider-img')}}" title="#caption3" />
				</div>
			...
			<div class="feature-product-area ptb-80">	
				<div class="container">
					...
					<div class="tab-content">
						<div class="tab-pane active show" id="Clothing">
